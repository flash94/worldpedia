...
public class buttonq extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buttonq);
        addListenerOnButton();
    }
    ...
    public void addListenerOnButton() {
        ...
        buttonCambodia= (Button) findViewById(R.id.buttonQatar);
        ...
        buttonCambodia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(context, qatar.class);
