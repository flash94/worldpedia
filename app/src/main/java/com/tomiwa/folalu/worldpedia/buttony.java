...
public class buttony extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.buttony);
        addListenerOnButton();
    }
    ...
    public void addListenerOnButton() {
        ...
        buttonCambodia= (Button) findViewById(R.id.buttonYemen);
        ...
        buttonCambodia.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(context, yemen.class);
